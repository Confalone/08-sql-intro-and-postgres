...
app.get('/new', (request, response) => {
  ...
  // 2 and 5; insert record is interacting with this line of code.  The CREATE part of crud is being enacted here.
...
app.get('/articles', (request, response) => {
  ...
  // 2,3,4 AND 5;  fetchall is interacting with the following line of code.  Read and Update are being enacted
...
app.post('/articles', (request, response) => {
  // COMMENTed: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // 2,3,4; loadAll is interacting.  create read update.
  client.query(
    `INSERT INTO
...
app.put('/articles/:id', (request, response) => {
  // COMMENTed: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // 3,4; updateRecord is interacting.  UPDATE part of CRUD
  client.query(
...
app.delete('/articles/:id', (request, response) => {
  // COMMENTed: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // 2,3; deleteRecord is interacting.  DELETING part of CRUD
  client.query(
...
app.delete('/articles', (request, response) => {
  // COMMENTed: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // 3,4; truncateTable interacts.  Deleting part of CRUD
  client.query(
...
// is calling function loadDB and populating the DOM with the contents of the DB.
loadDB();
...
function loadArticles() {
  // COMMENTed: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // 1,2,3,4,5; toHTML interacts here.  Read Update parts of CRUD
